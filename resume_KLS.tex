...
\nopagebreak
    ...
    \cvline{Co-author}{\href{https://github.com/SchlossLab/mothur-snakemake-workflow}{\textbf{mothur snakemake workflow}}. Template for mothur workflows (Python + R)}
    ...
    \cvline{Co-author}{\href{https://github.com/umcarpentries/intro-curriculum-r}{\textbf{Workshop curriculum}} on reproducible research with R, the Unix shell, \& git/GitHub}
